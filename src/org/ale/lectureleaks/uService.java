...
//        }
    ...
    public void setDataFromPrefs() {
    	int topRecording = prefs.getInt("top_recording", 0);
    ...
    public void update_notification(){
        ...
        if (notification == null){
            notification = new Notification(R.drawable.icon, "Uploading.." , System.currentTimeMillis());}
        ...
        contentView.setTextViewText(R.id.text, "This may take some time. Please wait.");
    ...
    public void done_notification(){
      ...
      notification = new Notification(R.drawable.icon, "Finished uploading!" , System.currentTimeMillis());
      contentView = new RemoteViews(getPackageName(), R.xml.progressview);
      contentView.setImageViewResource(R.id.image, R.drawable.icon);
      notificationIntent = new Intent(this, MainMenuActivity.class);
      contentIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);
      
      contentView.setTextViewText(R.id.text, "Finished uploading!");
      notification.contentView = contentView;
      notification.contentIntent = contentIntent;
