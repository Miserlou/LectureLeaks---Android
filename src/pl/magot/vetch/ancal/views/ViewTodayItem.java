...
public class ViewTodayItem extends View
{
	...
	protected final static int iColorTextActive_enabled = 0xFFFFFFFF;
	protected final static int iColorTextActive_disabled = 0xFFFFFFFF;
  ...
  public void Update()
  {
    ...
    if (IsViewFocused())
    {
      //set gradient text shader
	  	...
	  	iTextColorEnd = iTextColor & 0xFFFFFFFF;
    ...
    //set gradient text shader
		iTextColor = (IsViewFocused())?0xFFFFFFFF:iActiveTextColor;		
	  iTextColorEnd = iTextColor & 0xFFFFFFFF;
		LinearGradient lGrad = new LinearGradient(iWidth - 16, 0, iWidth - 6, 0,
				iTextColor, iTextColorEnd, Shader.TileMode.CLAMP);		
		mpt.setShader(lGrad);
